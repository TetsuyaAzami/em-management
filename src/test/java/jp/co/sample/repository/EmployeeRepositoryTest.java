...
class EmployeeRepositoryTest {
	...
	private final Employee employee1 = new Employee(1, "testname1", "testimage1", "男性", LocalDate.of(1111, 11, 11),
			"user1@sample.com", "010-0000", "北海道札幌市1-1-1", "010-0000-0000", 100000, "testcomment1", 1);
	...
	void findAllTest() {
		...
		assertEquals(27, employeeList.size());
		assertTrue(employee1.equals(employeeList.get(0)));
		assertEquals(5, employeeList.get(4).getId());
